...
insert into auth.users (id) values ('0f000000-0000-4000-8000-0000000000c1') on conflict do nothing;
insert into public.users (id,full_name,email,status) values
  ('0f000000-0000-4000-8000-0000000000c1','Owner','o@a2.test','active');
