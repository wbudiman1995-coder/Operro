...
begin
  ...
  insert into public.bookings (id,organization_id,branch_id,customer_id,pet_id,booking_type,status,fulfillment_mode,starts_at,ends_at,service_id,service_name_snapshot,price_snapshot,currency,notes,metadata) values
  ('d0000000-0000-4000-8000-000000000501',v_org,v_branch,'d0000000-0000-4000-8000-000000000301','d0000000-0000-4000-8000-000000000401','grooming','completed','home',v_start-interval '1 day',v_start-interval '1 day'+interval '90 minutes','d0000000-0000-4000-8000-000000000101','Basic Grooming',175000,'IDR','Demo selesai','{"demo_seed":"homepaw_v1"}'),
  ('d0000000-0000-4000-8000-000000000502',v_org,v_branch,'d0000000-0000-4000-8000-000000000302','d0000000-0000-4000-8000-000000000402','grooming','confirmed','home',v_start,v_start+interval '90 minutes','d0000000-0000-4000-8000-000000000101','Basic Grooming',175000,'IDR','Kulit sensitif','{"demo_seed":"homepaw_v1"}'),
  ('d0000000-0000-4000-8000-000000000503',v_org,v_branch,'d0000000-0000-4000-8000-000000000303','d0000000-0000-4000-8000-000000000403','grooming','in_progress','in_store',v_start+interval '2 hours',v_start+interval '3 hours','d0000000-0000-4000-8000-000000000103','De-shedding',125000,'IDR','Kucing, gunakan dryer rendah','{"demo_seed":"homepaw_v1"}'),
  ('d0000000-0000-4000-8000-000000000504',v_org,v_branch,'d0000000-0000-4000-8000-000000000304','d0000000-0000-4000-8000-000000000404','grooming','confirmed','home',v_start+interval '1 day',v_start+interval '1 day 150 minutes','d0000000-0000-4000-8000-000000000102','Full Grooming',300000,'IDR','Bawa dryer senyap','{"demo_seed":"homepaw_v1"}'),
  ('d0000000-0000-4000-8000-000000000505',v_org,v_branch,'d0000000-0000-4000-8000-000000000305','d0000000-0000-4000-8000-000000000405','grooming','confirmed','home',v_start+interval '1 day 3 hours',v_start+interval '1 day 5 hours','d0000000-0000-4000-8000-000000000101','Basic Grooming',350000,'IDR','Dua hewan','{"demo_seed":"homepaw_v1"}'),
  ('d0000000-0000-4000-8000-000000000506',v_org,v_branch,'d0000000-0000-4000-8000-000000000306','d0000000-0000-4000-8000-000000000407','grooming','requested','pickup_delivery',v_start+interval '2 days',v_start+interval '2 days 90 minutes','d0000000-0000-4000-8000-000000000101','Basic Grooming',175000,'IDR','Pickup pukul 08:30','{"demo_seed":"homepaw_v1"}')
